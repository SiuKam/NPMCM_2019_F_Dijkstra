...
mark_me = ones(1,length(data_set));
...
plot3(data_set(1,2),data_set(1,3),data_set(1,4),'.k')
hold on
...
while mark_meme ~= 1    
    for i = S_matrix(:,1).'
        id_to_S = find(S_matrix(:,1)==i);
        if mark_me(1,i) == mark_meme
            if mod(mark_meme,4) == 0
                plot3(data_set(i,2),data_set(i,3),data_set(i,4),'.r')
            elseif mod(mark_meme,4) ==1
                plot3(data_set(i,2),data_set(i,3),data_set(i,4),'.g')
            elseif mod(mark_meme,4) == 2
                plot3(data_set(i,2),data_set(i,3),data_set(i,4),'.b')
            elseif mod(mark_meme,4) == 3
                plot3(data_set(i,2),data_set(i,3),data_set(i,4),'.k')
            end
        end
    end
    mark_meme = mark_meme - 1;
